...
from mockafka.aiokafka import FakeAIOKafkaConsumer, FakeAIOKafkaProducer, FakeAIOKafkaAdmin
...
async def test_produce_and_consume():
    ...
    await producer.send(headers={}, key='test_key', value='test_value', topic='test_topic', partition=0, )
